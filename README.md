...
Librerías necesarias:Instala las siguientes librerías usando pip:pip install pandas numpy seaborn matplotlib plotly scikit-learn

En Colab, estas librerías suelen estar preinstaladas, pero verifica ejecutando:import pandas, numpy, seaborn, matplotlib, plotly, sklearn



Pasos para Ejecutar

Clonar el repositorio (si usas un entorno local):git clone https://github.com/carlo55anchez/TelecomX-Analysis2.git
...
En local: Usa Jupyter Notebook o VS Code:jupyter notebook notebooks/data_preparation.ipynb




Cargar los datos:
El cuaderno carga automáticamente TelecomX_Data_standardized.csv desde:url = 'https://raw.githubusercontent.com/carlo55anchez/TelecomX-Analysis2/main/data/TelecomX_Data_standardized.csv'
df = pd.read_csv(url)
...
En Colab, los gráficos se guardan en img/. Descárgalos desde el panel de archivos o usa:import shutil
